  ...
  return (
    <svg className="brand-mark" viewBox="0 0 40 40" aria-hidden="true">
      <polygon
        ...
        strokeWidth="2.5"
      />
      <ellipse cx="20" cy="22" rx="7" ry="9" fill="#D6A443" />
      <rect x="13" y="18" width="14" height="3" fill="#575091" />
      <rect x="13" y="24" width="14" height="3" fill="#575091" />
      <ellipse cx="14" cy="14" rx="5" ry="3.5" fill="#575091" opacity="0.55" transform="rotate(-25 14 14)" />
      <ellipse cx="26" cy="14" rx="5" ry="3.5" fill="#575091" opacity="0.55" transform="rotate(25 26 14)" />
      <circle cx="17.5" cy="11" r="1.3" fill="#575091" />
      <circle cx="22.5" cy="11" r="1.3" fill="#575091" />
    </svg>
  )
}
